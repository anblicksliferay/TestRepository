...
public class cla_kpiCacheModel implements CacheModel<cla_kpi>, Externalizable {
	...
	public cla_kpi toEntityModel() {
		...
		if (peroidInput == null) {
			cla_kpiImpl.setPeroidInput(StringPool.BLANK);
		}
		else {
			cla_kpiImpl.setPeroidInput(peroidInput);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		peroidInput = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (peroidInput == null) {
			...
			objectOutput.writeUTF(peroidInput);
		}
	}
