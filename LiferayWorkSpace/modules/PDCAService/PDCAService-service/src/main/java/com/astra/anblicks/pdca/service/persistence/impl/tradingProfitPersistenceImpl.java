...
public class tradingProfitPersistenceImpl extends BasePersistenceImpl<tradingProfit>
	...
	protected tradingProfit toUnwrappedModel(tradingProfit tradingProfit) {
		...
		tradingProfitImpl.setTotalSum(tradingProfit.getTotalSum());
		tradingProfitImpl.setNotes_Npat(tradingProfit.getNotes_Npat());
		tradingProfitImpl.setNotes_NetForex(tradingProfit.getNotes_NetForex());
		tradingProfitImpl.setNotes_ppeDispos(tradingProfit.getNotes_ppeDispos());
		tradingProfitImpl.setNotes_RevalutiononPI(tradingProfit.getNotes_RevalutiononPI());
		tradingProfitImpl.setNotes_Investment(tradingProfit.getNotes_Investment());
		tradingProfitImpl.setNotes_taxExpenses(tradingProfit.getNotes_taxExpenses());
		tradingProfitImpl.setNotes_impartmentOnAsset(tradingProfit.getNotes_impartmentOnAsset());
		tradingProfitImpl.setNotes_others(tradingProfit.getNotes_others());
