...
public class kpiCacheModel implements CacheModel<kpi>, Externalizable {
	...
	public String toString() {
		...
		sb.append(itemDescriptionName);
		sb.append(", itemDescriptionValue=");
		sb.append(itemDescriptionValue);
		sb.append(", userId=");
		sb.append(userId);
		sb.append(", userName=");
	...
	public kpi toEntityModel() {
		...
		if (itemDescriptionValue == null) {
			kpiImpl.setItemDescriptionValue(StringPool.BLANK);
		}
		else {
			kpiImpl.setItemDescriptionValue(itemDescriptionValue);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		itemDescriptionValue = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (itemDescriptionValue == null) {
			...
			objectOutput.writeUTF(itemDescriptionValue);
		}
