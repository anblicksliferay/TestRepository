...
/**
 * The base model implementation for the kpi service. Represents a row in the &quot;pdca_kpi&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class kpiModelImpl extends BaseModelImpl<kpi> implements kpiModel {
	 ...
	 */
	public static final String TABLE_NAME = "pdca_kpi";
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "itemDescriptionValue", Types.VARCHAR },
			{ "userId", Types.BIGINT },
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("itemDescriptionValue", Types.VARCHAR);
	...
	public static kpi toModel(kpiSoap soapModel) {
		...
		model.setItemDescriptionValue(soapModel.getItemDescriptionValue());
	...
	public Object clone() {
		...
		kpiImpl.setItemDescriptionValue(getItemDescriptionValue());
	...
	public CacheModel<kpi> toCacheModel() {
		...
		kpiCacheModel.itemDescriptionValue = getItemDescriptionValue();

		String itemDescriptionValue = kpiCacheModel.itemDescriptionValue;

		if ((itemDescriptionValue != null) &&
				(itemDescriptionValue.length() == 0)) {
			kpiCacheModel.itemDescriptionValue = null;
		}
	...
	public String toString() {
		...
		sb.append(getItemDescriptionValue());
		sb.append(", userId=");
		sb.append(getUserId());
		sb.append(", userName=");
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>itemDescriptionValue</column-name><column-value><![CDATA[");
		sb.append(getItemDescriptionValue());
		sb.append("]]></column-value></column>");
		sb.append(
