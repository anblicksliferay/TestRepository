...
public class cla_kpiWrapper implements cla_kpi, ModelWrapper<cla_kpi> {
	...
	*/
	...
	/**
	* Returns the peroid input of this cla_kpi.
	*
	* @return the peroid input of this cla_kpi
	*/
	@Override
	public java.lang.String getPeroidInput() {
		return _cla_kpi.getPeroidInput();
	}
	...
	*/
	...
	/**
	* Sets the peroid input of this cla_kpi.
	*
	* @param peroidInput the peroid input of this cla_kpi
	*/
	@Override
	public void setPeroidInput(java.lang.String peroidInput) {
		_cla_kpi.setPeroidInput(peroidInput);
	}
