...
/**
 * Provides the local service interface for ControlMOM. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ControlMOMLocalServiceUtil
...
public interface ControlMOMLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ControlMOMLocalServiceUtil} to access the control mom local service. Add custom service methods to {@link com.astra.anblicks.pdca.service.impl.ControlMOMLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ControlMOM addControlMOM(ControlMOM controlMOM);
	...
	*/
	public ControlMOM createControlMOM(long ControlMOMId);
	...
	*/
	...
	public ControlMOM deleteControlMOM(ControlMOM controlMOM);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ControlMOM deleteControlMOM(long ControlMOMId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ControlMOM fetchControlMOM(long ControlMOMId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ControlMOM getControlMOM(long ControlMOMId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ControlMOM updateControlMOM(ControlMOM controlMOM);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ControlMOM> getControlMOMs(int start, int end);
