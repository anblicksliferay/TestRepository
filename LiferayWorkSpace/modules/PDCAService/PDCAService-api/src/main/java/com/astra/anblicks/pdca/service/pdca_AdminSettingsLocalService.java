...
/**
 * Provides the local service interface for pdca_AdminSettings. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see pdca_AdminSettingsLocalServiceUtil
...
public interface pdca_AdminSettingsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link pdca_AdminSettingsLocalServiceUtil} to access the pdca_ admin settings local service. Add custom service methods to {@link com.astra.anblicks.pdca.service.impl.pdca_AdminSettingsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
