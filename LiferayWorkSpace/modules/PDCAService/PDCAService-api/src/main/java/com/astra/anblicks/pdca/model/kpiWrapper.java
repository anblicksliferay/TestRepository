...
public class kpiWrapper implements kpi, ModelWrapper<kpi> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("itemDescriptionValue", getItemDescriptionValue());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String itemDescriptionValue = (String)attributes.get(
				"itemDescriptionValue");

		if (itemDescriptionValue != null) {
	...
	*/
	...
	/**
	* Returns the item description value of this kpi.
	*
	* @return the item description value of this kpi
	*/
	@Override
	public java.lang.String getItemDescriptionValue() {
		return _kpi.getItemDescriptionValue();
	}
	...
	*/
	...
	/**
	* Sets the item description value of this kpi.
	*
	* @param itemDescriptionValue the item description value of this kpi
	*/
	@Override
	public void setItemDescriptionValue(java.lang.String itemDescriptionValue) {
		_kpi.setItemDescriptionValue(itemDescriptionValue);
	}
