...
/**
 * The persistence interface for the astra pdca_ year service.
 *
 * <p>
 ...
 * @see AstraPdca_YearUtil
 * @generated
 */
@ProviderType
public interface AstraPdca_YearPersistence extends BasePersistence<AstraPdca_Year> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AstraPdca_YearUtil} to access the astra pdca_ year persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<AstraPdca_Year> astraPdca_Years);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AstraPdca_Year> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<AstraPdca_Year> findAll();
	...
	*/
	public java.util.List<AstraPdca_Year> findAll(int start, int end);
	...
	*/
	public java.util.List<AstraPdca_Year> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AstraPdca_Year> orderByComparator);
