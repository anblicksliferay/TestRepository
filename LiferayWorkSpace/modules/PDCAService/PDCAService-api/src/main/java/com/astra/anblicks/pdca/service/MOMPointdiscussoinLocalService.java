...
/**
 * Provides the local service interface for MOMPointdiscussoin. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MOMPointdiscussoinLocalServiceUtil
...
public interface MOMPointdiscussoinLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MOMPointdiscussoinLocalServiceUtil} to access the mom pointdiscussoin local service. Add custom service methods to {@link com.astra.anblicks.pdca.service.impl.MOMPointdiscussoinLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MOMPointdiscussoin addMOMPointdiscussoin(
	...
	*/
	public MOMPointdiscussoin createMOMPointdiscussoin(long PdId);
	...
	*/
	...
	public MOMPointdiscussoin deleteMOMPointdiscussoin(
		MOMPointdiscussoin momPointdiscussoin);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MOMPointdiscussoin deleteMOMPointdiscussoin(long PdId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MOMPointdiscussoin fetchMOMPointdiscussoin(long PdId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MOMPointdiscussoin getMOMPointdiscussoin(long PdId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MOMPointdiscussoin updateMOMPointdiscussoin(
		MOMPointdiscussoin momPointdiscussoin);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MOMPointdiscussoin> getMOMPointdiscussoins(int start, int end);
