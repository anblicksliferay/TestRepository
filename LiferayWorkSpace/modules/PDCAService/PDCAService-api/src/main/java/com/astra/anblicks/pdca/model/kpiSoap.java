...
public class kpiSoap implements Serializable {
	public static kpiSoap toSoapModel(kpi model) {
		...
		soapModel.setItemDescriptionValue(model.getItemDescriptionValue());
	...
	public String getItemDescriptionValue() {
		return _itemDescriptionValue;
	}

	public void setItemDescriptionValue(String itemDescriptionValue) {
		_itemDescriptionValue = itemDescriptionValue;
	}
	...
	private String _itemDescriptionValue;
