...
/**
 * The persistence interface for the mom pointdiscussoin service.
 *
 * <p>
 ...
 * @see MOMPointdiscussoinUtil
 * @generated
 */
@ProviderType
public interface MOMPointdiscussoinPersistence extends BasePersistence<MOMPointdiscussoin> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MOMPointdiscussoinUtil} to access the mom pointdiscussoin persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<MOMPointdiscussoin> momPointdiscussoins);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MOMPointdiscussoin> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MOMPointdiscussoin> findAll();
	...
	*/
	public java.util.List<MOMPointdiscussoin> findAll(int start, int end);
	...
	*/
	public java.util.List<MOMPointdiscussoin> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MOMPointdiscussoin> orderByComparator);
