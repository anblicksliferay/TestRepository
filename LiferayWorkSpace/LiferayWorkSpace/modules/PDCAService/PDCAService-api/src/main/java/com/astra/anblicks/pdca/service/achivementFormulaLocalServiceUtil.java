...
/**
 * Provides the local service utility for achivementFormula. This utility wraps
 * {@link com.astra.anblicks.pdca.service.impl.achivementFormulaLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class achivementFormulaLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.astra.anblicks.pdca.service.impl.achivementFormulaLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.astra.anblicks.pdca.model.achivementFormula addachivementFormula(
		com.astra.anblicks.pdca.model.achivementFormula achivementFormula) {
		return getService().addachivementFormula(achivementFormula);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.achivementFormula createachivementFormula(
		long achivementFormulaId) {
		return getService().createachivementFormula(achivementFormulaId);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.achivementFormula deleteachivementFormula(
		com.astra.anblicks.pdca.model.achivementFormula achivementFormula) {
		return getService().deleteachivementFormula(achivementFormula);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.achivementFormula deleteachivementFormula(
		...
		return getService().deleteachivementFormula(achivementFormulaId);
	}

	public static com.astra.anblicks.pdca.model.achivementFormula fetchachivementFormula(
		long achivementFormulaId) {
		return getService().fetchachivementFormula(achivementFormulaId);
	}
	...
	* @throws PortalException if a achivement formula with the primary key could not be found
	*/
	public static com.astra.anblicks.pdca.model.achivementFormula getachivementFormula(
		long achivementFormulaId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getachivementFormula(achivementFormulaId);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.achivementFormula updateachivementFormula(
		com.astra.anblicks.pdca.model.achivementFormula achivementFormula) {
		return getService().updateachivementFormula(achivementFormula);
	}
	...
	*/
	public static int getachivementFormulasCount() {
		return getService().getachivementFormulasCount();
	}
	...
	*/
	public static java.util.List<com.astra.anblicks.pdca.model.achivementFormula> getachivementFormulas(
		int start, int end) {
		return getService().getachivementFormulas(start, end);
	}
	...
	*/
	...
	public static achivementFormulaLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<achivementFormulaLocalService, achivementFormulaLocalService> _serviceTracker =
		ServiceTrackerFactory.open(achivementFormulaLocalService.class);
}