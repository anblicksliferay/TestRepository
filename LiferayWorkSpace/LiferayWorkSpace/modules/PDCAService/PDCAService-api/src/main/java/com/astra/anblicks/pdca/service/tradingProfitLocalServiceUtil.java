...
/**
 * Provides the local service utility for tradingProfit. This utility wraps
 * {@link com.astra.anblicks.pdca.service.impl.tradingProfitLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class tradingProfitLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.astra.anblicks.pdca.service.impl.tradingProfitLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit addtradingProfit(
		com.astra.anblicks.pdca.model.tradingProfit tradingProfit) {
		return getService().addtradingProfit(tradingProfit);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit createtradingProfit(
		long tradingProfitId) {
		return getService().createtradingProfit(tradingProfitId);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit deletetradingProfit(
		com.astra.anblicks.pdca.model.tradingProfit tradingProfit) {
		return getService().deletetradingProfit(tradingProfit);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit deletetradingProfit(
		...
		return getService().deletetradingProfit(tradingProfitId);
	}

	public static com.astra.anblicks.pdca.model.tradingProfit fetchtradingProfit(
		long tradingProfitId) {
		return getService().fetchtradingProfit(tradingProfitId);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit fetchtradingProfitByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService().fetchtradingProfitByUuidAndCompanyId(uuid, companyId);
	}
	...
	* @throws PortalException if a trading profit with the primary key could not be found
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit gettradingProfit(
		long tradingProfitId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().gettradingProfit(tradingProfitId);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit gettradingProfitByUuidAndCompanyId(
		java.lang.String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().gettradingProfitByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static com.astra.anblicks.pdca.model.tradingProfit updatetradingProfit(
		com.astra.anblicks.pdca.model.tradingProfit tradingProfit) {
		return getService().updatetradingProfit(tradingProfit);
	}
	...
	*/
	public static int gettradingProfitsCount() {
		return getService().gettradingProfitsCount();
	}
	...
	*/
	public static java.util.List<com.astra.anblicks.pdca.model.tradingProfit> gettradingProfits(
		int start, int end) {
		return getService().gettradingProfits(start, end);
	}
	...
	*/
	...
	public static tradingProfitLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<tradingProfitLocalService, tradingProfitLocalService> _serviceTracker =
		ServiceTrackerFactory.open(tradingProfitLocalService.class);
}